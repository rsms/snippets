/*
  ...
  Native only:
    g++ -Wall -Os -o find_app find_app.cc -framework ApplicationServices && strip find_app
  Universal:
    g++ -arch ppc -arch i386 -isysroot /Developer/SDKs/MacOSX10.4u.sdk -Wall -Os \
      -o find_app find_app.cc -framework ApplicationServices && strip find_app
